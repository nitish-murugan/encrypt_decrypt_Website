<?php
session_start();
if(!isset($_SESSION['emailAddress']) || (!isset($_SESSION['fname']))) {
...
<body>
    ...
    <div class="container">
        ...
        if(isset($_SESSION['emailAddress'])) {
            ...
            $name = "Welcome " . $fname . "!";
            echo "<p class='welcomeUser'> $name </p>";
        }
        ?>
    </div>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                echo "<p style='color:white;margin-left:250px;font-weight:bold;'> <u> $name </u> </p>";  
                ?>
